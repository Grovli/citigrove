...
export function StickyTryGrovli({ campaign }: StickyTryGrovliProps) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-40 inline-flex items-center gap-2.5 rounded-full px-5 py-3.5 text-[13px] font-bold tracking-[0.04em] uppercase text-[#FAFAF6] shadow-lg transition-all duration-300 ${
        visible
      ...
      style={{
        ...
        boxShadow: "0 20px 50px rgba(30,51,40,0.35)",
      }}
    >
