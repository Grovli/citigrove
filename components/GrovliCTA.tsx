...
export function GrovliCTA({ campaign, variant = "band" }: GrovliCTAProps) {
  ...
  if (variant === "compact") {
    return (
      <div className="my-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl px-6 py-5 border border-[#1A1916]/[0.10] bg-[#F0EBE1]">
        <p className="text-[15px] leading-[1.5] text-[#1A1916]/80 m-0">
        ...
        <a
          ...
          style={{ backgroundColor: "#1E3328", color: "#FAFAF6" }}
        >
  ...
  return (
    ...
    >
      <div
        ...
        style={{ color: "rgba(250,250,246,0.55)" }}
      >
      ...
      <p
        ...
        style={{ color: "rgba(250,250,246,0.72)" }}
      >
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        <a
          ...
          style={{ backgroundColor: "#FAFAF6", color: "#1A1916" }}
        >
          Start food planning <span aria-hidden>→</span>
        </a>
        <a
          ...
          style={{ border: "1px solid rgba(250,250,246,0.30)", color: "#FAFAF6" }}
        >
          Get the iPhone app
        </a>
      </div>
