  ...
  return (
    <main className="min-h-screen bg-[#F1ECE1] text-[#3B362D]">
      ...
      <section className="max-w-[1100px] mx-auto px-8 pt-20 pb-12">
        ...
        <p className="max-w-[640px] text-[17px] text-[#3B362D]/70 leading-[1.65] mt-6">
          ...
          <a
            ...
            className="text-[#8A4A28] underline underline-offset-2"
          >
            Grovli
          </a>
      ...
      <section className="max-w-[1100px] mx-auto px-8 pb-32">
        {items.length === 0 ? (
          <div className="border-t border-[#3B362D]/[0.08] pt-12 text-[15px] text-[#3B362D]/60">
            We&apos;re writing — posts are coming soon. Subscribe from any essay
            to be the first to hear when the journal opens.
          </div>
        ) : (
          <ul className="border-t border-[#3B362D]/[0.08]">
            {items.map((post) => (
              <li
                key={post.slug}
                className="border-b border-[#3B362D]/[0.08] py-10"
              >
                <Link href={`/blog/${post.slug}`} className="group block">
                  <div className="text-[11px] tracking-[0.18em] uppercase text-[#8A4A28] font-semibold mb-3">
                  ...
                  <p className="text-[16px] text-[#3B362D]/70 leading-[1.65] mt-3 max-w-[760px]">
                    {post.summary}
                  </p>
                  <span className="inline-block mt-4 text-[12px] tracking-[0.18em] uppercase text-[#8A4A28] font-semibold">
                    Read essay →
                  </span>
                </Link>
              </li>
